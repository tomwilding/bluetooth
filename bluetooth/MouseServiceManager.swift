...
protocol MouseServiceManagerDelegate {
...
class MouseServiceManager : NSObject {
    ...
    var delegate : MouseServiceManagerDelegate?
...
extension MouseServiceManager : MCNearbyServiceBrowserDelegate {
...
extension MouseServiceManager : MCSessionDelegate {
